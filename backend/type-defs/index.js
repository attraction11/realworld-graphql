...
const typeDefs = gql`
  ...
  type Mutation {
    ...
    # Article
    createArticle(article: CreateArticleInput): CreateArticlePayload 
    updateArticle(id: String, article: CreateArticleInput): CreateArticlePayload 
    deleteArticle(id: String): CreateArticlePayload 
  }
`
